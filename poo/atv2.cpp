...
int main(){
    ...
    for(int i= 0; i<2; i++){
        ...
        // Criar um novo objeto Clientes com as informações fornecidas e armazená-lo no vetor de ponteiros
     ...
     for(int i=0; i<2;i++){
        ...
        // Chama o método exibirCliente para mostrar os dados de cada cliente
     }
